...
// const API_URL = 'http://localhost:8080/form_submit';
// const API_URL = 'http://10.0.2.2:8080/form_submit';
// const API_URL = 'https://backend-app-t0ym.onrender.com/form_submit';
...
export default function CaseRecordForm({API_URL}) {
    ...
    const handleFeedbackPress = async () => {
        try {
            ...
            const checkResponse = await fetch('http://localhost:8080/check_feedback', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`
                },
    ...
    return (
        <ScrollView style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputGroup}>
                    <Text style={styles.label}>Take Photo / Choose from Gallery</Text>
